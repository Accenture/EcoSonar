...
export default function LightHousePanelPerProject (props) {
  const { loading, error, projectName, lighthouseMetricsForProject, lighthousePerformanceForProject, lighthouseAccessibilityForProject } = props
  return (
    <div>
          ...
          {loading
            ...
            <div>
              ...
              {error === '' &&
                ...
                Object.keys(lighthousePerformanceForProject).length === 0 &&
                lighthouseAccessibilityForProject &&
                Object.keys(lighthouseAccessibilityForProject).length === 0 && <p className='text-danger'>{formatError(errors.errorLighthouseAnalysisNotFound, projectName)}</p>}
              {error === '' &&
                lighthousePerformanceForProject &&
                Object.keys(lighthousePerformanceForProject).length !== 0 &&
                lighthouseAccessibilityForProject &&
                Object.keys(lighthouseAccessibilityForProject).length !== 0 && (
                  <div>
                    <ul>
                              ...
                              <li className='centered-lighthouse-score'>
                                <span className='centered-score'>
                                  ...
                                  <span className='lightouse-score'>
                                    ...
                                    {setLetter(lighthousePerformanceForProject.perfComplianceLevel)}
                                  </span>
                                </span>
                              </li>
                              <li className='centered-lighthouse-score'>
                                <span className='centered-score'>
                                  ...
                                  <span className='lightouse-score'>
                                    ...
                                    {setLetter(lighthouseAccessibilityForProject.accessComplianceLevel)}
                                  </span>
                                </span>
                              </li>
                          </ul>
                        ...
                        <div className='display-flex-row overview-measures-row bordered'>
                          <div className='overview-panel-big-padded flex-1 small-text display-flex-center big-spacer-left lighthouse-metric'>
                            <div className='left-part'>
                              <p className='overview-measures-value  a'>{lighthouseMetricsForProject.largestContentfulPaint.displayValue}</p>
                            ...
                            {setLetter(lighthouseMetricsForProject.largestContentfulPaint.complianceLevel)}
                          </div>
                        </div>
                      </li>
                        ...
                        <ul className='display-flex-row overview-measures-row'>
                            <li>
                              <div className='overview-panel-huge-padded flex-1 small-text bordered-right display-flex-center lighthouse-metric'>
                                <div className='left-part'>
                                  <div className='display-flex-center'>
                                    <div className='display-flex-column'>
                                      <span>
                                        <p className='overview-measures-value  a'>{lighthouseMetricsForProject.cumulativeLayoutShift.displayValue}</p>
                                      </span>
                                ...
                                {setLetter(lighthouseMetricsForProject.cumulativeLayoutShift.complianceLevel)}
                              </div>
                            </li>
                              ...
                              <div className='overview-panel-huge-padded small-text flex-1 display-flex-center lighthouse-metric'>
                                <div className='left-part'>
                                  <div className='display-flex-center'>
                                    <div className='display-flex-column'>
                                      <span>
                                        <p className='overview-measures-value  a'>{lighthouseMetricsForProject.firstContentfulPaint.displayValue}</p>
                                      </span>
                                      <span className='spacer-top'>
                                ...
                                {setLetter(lighthouseMetricsForProject.firstContentfulPaint.complianceLevel)}
                              </div>
                            </li>
                        </ul>
                      </li>
                            ...
                            <li>
                              <div className='overview-panel-huge-padded flex-1 small-text bordered display-flex-center lighthouse-metric'>
                                <div className='display-flex-center'>
                                  <div className='display-flex-column'>
                                    <span>
                                      <p className='overview-measures-value  a'>{lighthouseMetricsForProject.speedIndex.displayValue}</p>
                                    </span>
                                    <span className='spacer-top'>
                                ...
                                {setLetter(lighthouseMetricsForProject.speedIndex.complianceLevel)}
                              </div>
                            </li>
                            ...
                            <li>
                              <div className='overview-panel-huge-padded flex-1 small-text bordered display-flex-center lighthouse-metric'>
                                <div className='display-flex-center'>
                                  <div className='display-flex-column'>
                                    <span>
                                      <p className='overview-measures-value  a'>{lighthouseMetricsForProject.totalBlockingTime.displayValue}</p>
                                    </span>
                                    <span className='spacer-top'>
                                ...
                                {setLetter(lighthouseMetricsForProject.totalBlockingTime.complianceLevel)}
                              </div>
                            </li>
                            ...
                            <li>
                              <div className='overview-panel-huge-padded flex-1  small-text bordered display-flex-center lighthouse-metric'>
                                <div className='display-flex-center'>
                                  <div className='display-flex-column'>
                                    <span>
                                      <p className='overview-measures-value  a'>{lighthouseMetricsForProject.interactive.displayValue}</p>
                                    </span>
                                    <span className='spacer-top'>
                                      ...
                                      <text className='tooltip little-spacer-left' tabIndex={0}>
                                        ...
                                        <p className='tooltiptext request-tool'>
                                          ...
                                          speed. Measuring TTI is important because some sites optimize content visibility at the expense of interactivity. This can create a frustrating user
                                          experience: the site appears to be ready, but when the user tries to interact with it, nothing happens.
                                        </p>
                                      </text>
                                    </span>
                                  </div>
                                </div>
                                {setLetter(lighthouseMetricsForProject.interactive.complianceLevel)}
                              </div>
                            </li>
                        </ul>
                      </li>
